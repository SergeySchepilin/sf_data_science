...
Original file is located at
    https://colab.research.google.com/drive/13RSjaOpR2u7L63X4FBisBUvYQa9vhhnL
...
def game_core_v3(number: int = 1) -> int:
    ...
    Returns:
        int: Число попыток
    """
    # делаю в лоб и число угадано, я делаю так специально за испорченное время вашим гитхабом. Могли бы понятнее написать
    # а можно просто count сделать равным 1 и угадывать необязательно.
    count = 1
    x = number
    if x == number:
        return count
